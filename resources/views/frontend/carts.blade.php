                        ...
                        <table class="table-responsive cart-wrap">
                            ...
                            <tbody>
                                @foreach ($carts as $cart)
                                    <tr>
                                        <td class="images"><img
                                                src="{{asset('backend/assets/images/product-img/' . $cart->relationToProduct->image)}}" alt=""></td>
                                        <td class="product"><a href="{{route('single.product', $cart->product_id)}}">{{$cart->relationToProduct->name}}</a></td>
                                        <td class="price">$ {{$cart->relationToProduct->price}}</td>
                                        <td class="quantity cart-plus-minus">
                                            <input type="text" value="{{$cart->amount}}" />
                                        </td>
                                        <td class="total">$ {{$cart->relationToProduct->price * $cart->amount}}</td>
                                        <td class="remove">
