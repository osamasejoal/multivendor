                    ...
                    <div class="order-area">
                        ...
                        <ul class="total-cost">
                            ...
                            <li class="order-main-li">
                                ...
                                <ul>
                                    <li>Product Name <span class="pull-right">$xfg</span> </li>
                                    <li>Product Name <span class="pull-right">$xfg</span> </li>
                                    <li>Product Name <span class="pull-right">$xfg</span> </li>
                                </ul>
                            </li>
                            ...
                            <li class="order-main-li">
                                <ul>
                                    <li>Cart Total <span class="pull-right">$56</span> </li>
                                    <li>Discount <span class="pull-right">$56</span> </li>
                                    <li class="font-weight-bold">Subtotal <span class="pull-right">$56</span> </li>
                                </ul>
                            </li>

                            {{-- Shipping --}}
                            <li class="order-main-li">Delivery <span class="pull-right">Free</span></li>
                            <li class="order-main-li g-total-cost">Grand Total<span class="pull-right">$380.00</span></li>
                        </ul>
